...
impl JiraDatabase {
    ...
    pub fn create_epic(&self, epic: Epic) -> Result<u32> {
        ...
        let new_item_id = parsed.last_item_id + 1;

        parsed.last_item_id = new_item_id;
        parsed.epics.insert(new_item_id, epic);
    ...
    pub fn create_story(&self, story: Story, epic_id: u32) -> Result<u32> {
        ...
        parsed.last_item_id = new_item_id;
        parsed.stories.insert(new_item_id, story);
        parsed
            .epics
            .get_mut(&epic_id)
    ...
    pub fn delete_story(&self, epic_id: u32, story_id: u32) -> Result<()> {
        ...
        let epic = parsed
            .epics
            .get_mut(&epic_id)
            .ok_or_else(|| anyhow!("couldn't find epic"))?;
        let story_index = epic
            .stories
            .iter()
            .position(|story| *story == story_id)
            .ok_or_else(|| anyhow!("couldn't find story"))?;
...
impl Database for JSONFileDatabase {
    fn read_db(&self) -> Result<DBState> {
        ...
        let parsed: DBState = serde_json::from_str(&file_content)?;
        Ok(parsed)
    }
